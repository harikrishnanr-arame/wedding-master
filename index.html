...
<head>
    ...
    <link rel="stylesheet" href="homw.css">
...
<body>
    ...
    <section class="hero" style="background-image: url(./img/bg.png);">
  <!-- Navbar -->
...
<div class="template-stack left">
  <img class="img-one" src="img/i4.png" alt="Template 1">
  <img class="img-two" src="img/i2.png" alt="Template 2">
  <img class="img-three" src="img/i3.png" alt="Template 3">
</div>

<!-- RIGHT TEMPLATE STACK -->
<div class="template-stack right">
  <img class="img-one" src="img/i1.jpg" alt="Template 4">
  <img class="img-two" src="img/i5.png" alt="Template 5">
  <img class="img-three" src="img/i.jpg" alt="Template 6">
</div>
...
<section class="templates-section">
  <div class="container">
    ...
    <div class="section-decor" id="templates">
      <img src="img/floraldesign.png" alt="floral">
    </div>
    ...
    <div class="templates-grid">
      ...
      <div class="template-card">
        <img src="img/i.jpg" alt="Wedding Home 1">
      ...
      <div class="template-card">
        <img src="img/i1.jpg" alt="Muslim Wedding Home">
      ...
      <div class="template-card">
        <img src="img/i2.png" alt="Announcement Home 2">
        ...
        <div class="template-actions">
          ...
          <span class="heart">♡</span>
            ...
            <div class="template-card">
        <img src="img/i3.png" alt="Wedding Home 1">
        <h3>Wedding Home 1</h3>
        <div class="template-actions">
          <button onclick="location.href='templateEditPage.html'">Choose This Template</button>
          <span class="heart">♡</span>
      ...
      <div class="template-card">
        <img src="img/i4.png" alt="Muslim Wedding Home">
        <h3>Muslim Wedding Home</h3>
        <div class="template-actions">
          <button onclick="location.href='templateEditPage.html'">Choose This Template</button>
          <span class="heart">♡</span>
      ...
      <div class="template-card">
        <img src="img/i5.png" alt="Announcement Home 2">
        <h3>Announcement Home 2</h3>
        <div class="template-actions">
          <button onclick="location.href='templateEditPage.html'">Choose This Template</button>
          <span class="heart">♡</span>
...
<!-- review -->
<section class="testimonials-section" style="background-image: url(./img/bg2.png);">
  <div class="container">
    ...
    <div class="testimonials-grid">
      ...
      <div class="testimonial-item">
        <img src="img/reviewimg/review1.jpg" alt="Couple">
      ...
      <div class="testimonial-item reverse">
        ...
        <img src="img/reviewimg/review2.jpg" alt="Couple">
      </div>

      <!-- ITEM 3 -->
      <div class="testimonial-item">
        <img src="img/reviewimg/review3.webp" alt="Couple">
        <div class="testimonial-text">
          <p>
      ...
      <div class="testimonial-item reverse">
        ...
        <img src="img/reviewimg/review4.jpg" alt="Couple">
      </div>
...
<!-- footer  -->
<section class="cta-section" style="background-image: url(./img/bg2.png);">
